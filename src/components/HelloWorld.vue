    ...
    <div class="main">
        ...
        <div class="export">
            ...
            <h2 @click="settingsopen=!settingsopen"> Tweak <span v-if="settingsopen" >-</span> <span v-if="!settingsopen" >+</span>  </h2>
                <div v-if="settingsopen" class="settings">
                    <div class="settings-item">
                        <label class="settings-label">svg width</label>
                        <input class="settings-input" v-model="svgwidth" type="number" /><br>
                    </div>
                    <div class="settings-item">
                        <label class="settings-label">svg height</label>
                        <input class="settings-input" v-model="svgheight" type="number" /><br>
                    </div>
                    <div class="settings-item">
            ...
            <div  class="copy-mod">
                ...
                <h2 @click="copyCode">Copy SVG clipboard</h2>
            </div>
...
methods:{
    ...
    toMorse:function(letter){
        console.log('toMorse',letter,this.table)
